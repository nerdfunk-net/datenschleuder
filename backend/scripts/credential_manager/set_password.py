...
from services.auth.user_service import UserService as _UserService  # noqa: E402

_user_service = _UserService()
get_user_by_username = _user_service.get_user_by_username
update_user = _user_service.update_user
